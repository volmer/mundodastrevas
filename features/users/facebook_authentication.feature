Feature: Facebook authentication
  ...
  Scenario: Sign up successfully
    ...
    And I see the page heading "theon"
  ...
  Scenario: Complete sign up with some invalid Facebook data
    Given I have a Facebook account with the following information:
      | username | email          | bio          | gender | birthday   | location | image   |
      | jon.snow | jon@thewall.ws | I'm no crow. | male   | 08/16/1991 | The Wall | jon.jpg |
    And I am on the new user session page
    When I click on "Entrar com Facebook"
    ...
    And I see the link "Facebook" which leads to "http://facebook.com/jon.snow" when clicked
