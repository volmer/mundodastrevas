...
FactoryGirl.define do
  factory :universe do
    ...
    description "Vampire: The Requiem is a role-playing game published by White
      ...
      game, rather than a continuation of the previous editions, it uses many
      elements from the old game in its construction, including some of the
      clans and their powers. The game's title is a metaphor for the way
      vampires within the game view their (un)life."
